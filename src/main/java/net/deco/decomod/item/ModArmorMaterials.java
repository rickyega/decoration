...
public enum ModArmorMaterials implements ArmorMaterial {
    HELLSTONE("hellstone", 28, new int[]{4, 7, 9, 4}, 20, SoundEvents.ARMOR_EQUIP_GOLD,
            3.5F, 0.2F, () -> Ingredient.of(ModItems.HELLSTONE_INGOT.get()));
    ...
    public String getName() {
        return DecoMod.MOD_ID + ":" + this.name;
    }
